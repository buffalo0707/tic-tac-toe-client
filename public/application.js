...
/***/ function(module, exports, __webpack_require__) {
	...
	var gameEvents = __webpack_require__(16);
	var gameData = __webpack_require__(14);
	...
	var signInSuccess = function signInSuccess(data) {
	  ...
	  gameApi.createGame().then(gameUi.createSuccess).catch(gameUi.createFailure);
	  $('#sign-out-nav').show();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getGames = function getGames(isComplete) {
	  store.games = {};
	  if (isComplete) {
	    return $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var initializeSite = function initializeSite() {
	...
	var getSuccess = function getSuccess(data) {
	  ...
	  var games = store.games.length;
	  var wins = gameLogic.getWinHistory();
...
/***/ function(module, exports) {
	...
	// diag
	['0', '4', '8'], ['2', '4', '6']];
	var imageEmpire = 'https://i.imgur.com/inG89Ay.jpg';

	var imageRebel = 'https://i.imgur.com/chXYzaK.jpg';

	var imageBlank = 'https://i.imgur.com/BiJgF5Z.jpg';
	...
	var updatePlayerArray = function updatePlayerArray(player, id) {
	  if (player === 'o') {
	    oCells.push(id);
	  } else if (player === 'x') {
	    xCells.push(id);
	...
	var resetData = function resetData() {
	  ...
	  for (var _i = xCells.length; _i > 0; _i--) {
	    xCells.pop();
	  }
	  for (var _i2 = oCells.length; _i2 > 0; _i2--) {
	    oCells.pop();
	  }
	};
	...
	module.exports = {
	  ...
	  xCells: xCells,
	  gameOver: gameOver,
	  updatePlayerArray: updatePlayerArray,
	  resetData: resetData,
	  gameHistory: gameHistory,
	  imageEmpire: imageEmpire,
	  imageRebel: imageRebel,
	  imageBlank: imageBlank,
	  imagePlayerX: imagePlayerX,
	  imagePlayerO: imagePlayerO,
	  factionPlayerX: factionPlayerX,
	  factionPlayerO: factionPlayerO
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getWinHistory = function getWinHistory() {
	  var result = 0;
	  ...
	  var _loop = function _loop(_i) {
	    var selectedArray = gameData.gameHistory[_i];
	    var wins = gameData.winningCombos.some(function (array) {
	  ...
	  for (var _i = 0; _i < gameData.gameHistory.length; _i++) {
	    _loop(_i);
	  }
	...
	var selectedCells = function selectedCells(array, player) {
	  var result = [];
	...
	var isWin = function isWin(player) {
	  var selectedArray = [];
	  if (player === 'x') {
	  ...
	  for (var i = 0; i < gameData.winningCombos.length; i++) {
	...
	var isGameOver = function isGameOver(currentPlayer) {
	...
	var updateStats = function updateStats(isWin) {
	  var games = $('#completed-games').html();
	  var wins = $('#won-games').html();
	  games = +games + 1;
	  if (isWin) {
	    wins = +wins + 1;
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var chooseCell = function chooseCell(event) {
	  event.preventDefault();
	...
	var onGameFormSubmit = function onGameFormSubmit(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  event.preventDefault();
	...
	var getCompletedGames = function getCompletedGames() {
	  api.getGames(true).then(ui.getSuccess).catch(ui.getFailure);
	};
	var chooseSide = function chooseSide(event) {
	  ui.onChooseSide;
	  if (this.id === 'empire') {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "0a1244eef1555018dbc5b1e6c7593bf6.jpg";
